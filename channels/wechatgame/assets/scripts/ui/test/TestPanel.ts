...
export class TestPanel extends cc.Component {
    ...
    public async onLoad(): Promise<void> {
        console.log("sub TestPanel onLoad");
        this.mFriendList = GameEnv.instance.uiDirector.getParam<Friend[]>(this.node);
        console.log('sub TestPanel onLoad', this.mFriendList);
    ...
    public onDestroy(): void {
        console.log("sub TestPanel onDestroy");
        if (LibUtil.isNull(this.mFriendList)) {
            return;
        }
    ...
    private async init(): Promise<void> {
        console.log("sub TestPanel init");
    ...
    private onLoadingTimeOut(): void {
        console.log("sub TestPanel onLoadingTimeOut");
